...
function Modal({ setIsModalOpen }) {
  ...
  const userWallet = "0x84E4bbB9BD6e8E6D886dC32D6Aa5af6435289D40";
  const dateToWithdraw = 3363171270;

  const amount = 1;
  const value1 = 1 * 10 ** 18;
  const tempValue = 10000000000000;

  const freelanceContractAddress = "0x84E4bbB9BD6e8E6D886dC32D6Aa5af6435289D40";
  ...
  const { writeAsync: buyNow, isLoading, isMining } = useScaffoldContractWrite({
    ...
    args: [freelanceContractAddress, 1],
